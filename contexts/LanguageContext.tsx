...
const enTranslations: Translations = {
  ...
  "errors": { "fetch_failed": "Could not fetch the data. This might be a network issue or a CORS problem. Please ensure the URL is a direct, public link to a CSV file (e.g., from Google Sheets 'Publish to the web')." },
...
const frTranslations: Translations = {
  ...
  "errors": { "fetch_failed": "Impossible de récupérer les données. Il peut s'agir d'un problème de réseau ou de CORS. Veuillez vous assurer que l'URL est un lien public direct vers un fichier CSV (par exemple, depuis Google Sheets 'Publier sur le web')." },
