...
const enTranslations: Translations = {
  ...
  "header": { "last_update": "Last update", "seconds_ago": "a few seconds ago", "profit_today": "Today's Profit", "profit_yesterday": "Yesterday's Profit", "profit_x_days_ago": "Result {{count}} days ago", "sync_now": "Sync Now", "syncing": "Syncing..." },
  ...
  "account_action_modal": { "title": "Account Actions", "subtitle": "What would you like to do?", "add_new": "Add a New Account", "update_current": "Update Current Account" },
  "add_account_modal": { "title": "Add New Account", "title_update": "Update Account", "subtitle": "Provide account details and upload the trade history CSV.", "subtitle_update": "Update account details and upload new trades.", "account_name": "Account Name", "account_name_placeholder": "e.g., My Main Account", "initial_balance": "Initial Balance ($)", "initial_balance_placeholder": "e.g., 100000", "file_loaded": "File loaded:", "trades_found": "{{count}} trades found.", "trades_to_add": "{{count}} new trades will be added.", "clear_file": "Clear file", "save_button": "Save Account", "save_button_update": "Update Account", "data_source": "Data Source", "file_upload": "File Upload", "live_url": "Live URL", "csv_url": "CSV File URL", "csv_url_placeholder": "https://example.com/history.csv", "url_helper_text": "The app will periodically fetch this URL to sync new trades." },
...
const frTranslations: Translations = {
  ...
  "header": { "last_update": "Dernière mise à jour", "seconds_ago": "il y a quelques secondes", "profit_today": "Profit d'aujourd'hui", "profit_yesterday": "Profit d'hier", "profit_x_days_ago": "Résultat il y a {{count}} jours", "sync_now": "Synchroniser", "syncing": "Synchronisation..." },
  ...
  "account_action_modal": { "title": "Actions de Compte", "subtitle": "Que souhaitez-vous faire ?", "add_new": "Ajouter un nouveau compte", "update_current": "Mettre à jour le compte actuel" },
  "add_account_modal": { "title": "Ajouter un nouveau compte", "title_update": "Mettre à jour le Compte", "subtitle": "Fournissez les détails du compte et téléchargez le CSV de l'historique des trades.", "subtitle_update": "Mettez à jour les détails du compte et téléchargez de nouveaux trades.", "account_name": "Nom du compte", "account_name_placeholder": "ex: Mon compte principal", "initial_balance": "Solde initial ($)", "initial_balance_placeholder": "ex: 100000", "file_loaded": "Fichier chargé :", "trades_found": "{{count}} trades trouvés.", "trades_to_add": "{{count}} nouveaux trades seront ajoutés.", "clear_file": "Retirer le fichier", "save_button": "Enregistrer le compte", "save_button_update": "Mettre à jour le Compte", "data_source": "Source de Données", "file_upload": "Fichier Local", "live_url": "URL Active", "csv_url": "URL du fichier CSV", "csv_url_placeholder": "https://exemple.com/historique.csv", "url_helper_text": "L'application récupérera périodiquement cette URL pour synchroniser les nouveaux trades." },
