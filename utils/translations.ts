...
export const translations = {
  en: {
    ...
    "settings": { 
        ...
        "notifications_description": "Manage background notifications for your accounts.", 
        "enable_notifications": "Enable Notifications", 
        "notifications_denied": "Notifications are blocked. Please enable them in your browser settings.", 
        "trade_closed_notifications": "Trade Closed Alerts", 
        "weekly_summary_notifications": "Weekly Summary", 
        "background_sync_note": "Background notifications depend on your browser's sync frequency.", 
        "notifications_not_supported_alert": "Notifications are not supported in this browser.", 
        "notifications_not_granted_alert": "Notification permission has not been granted. Please enable notifications first.", 
        "service_worker_not_active_alert": "The app's background service is not active.", 
        "service_worker_connect_error_alert": "Could not connect to the app's background service.", 
        "language": "Language", 
        "english": "English", 
        "french": "French", 
        "sign_out": "Sign Out",
        "install_title": "Install App",
        "install_description": "Install Atlas on your device for the best experience.",
  ...
  fr: {
    ...
    "settings": { 
        "title": "Paramètres", 
        "notifications_title": "Notifications", 
        "notifications_description": "Gérez les notifications en arrière-plan.", 
        "enable_notifications": "Activer les Notifications", 
        "notifications_denied": "Les notifications sont bloquées.", 
        "trade_closed_notifications": "Alertes de Trade Clôturé", 
        "weekly_summary_notifications": "Résumé Hebdomadaire", 
        "background_sync_note": "Les notifications dépendent de la fréquence de synchronisation.", 
        "notifications_not_supported_alert": "Notifications non supportées.", 
        "notifications_not_granted_alert": "Permission non accordée.", 
        "service_worker_not_active_alert": "Service inactif.", 
        "service_worker_connect_error_alert": "Erreur de connexion au service.", 
        "language": "Langue", 
        "english": "Anglais", 
        "french": "Français", 
        "sign_out": "Se déconnecter",
        "install_title": "Installer l'application",
        "install_description": "Installez Atlas sur votre appareil pour une meilleure expérience.",
