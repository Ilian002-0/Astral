            ...
            <div className="overflow-x-auto">
                <table className="w-full text-sm text-left table-fixed">
                    <thead className="text-xs text-gray-400 uppercase border-b border-gray-700">
                        <tr>
                            <th scope="col" className="px-2 sm:px-4 py-3 w-[25%]">{t('dashboard.symbol')}</th>
                            <th scope="col" className="px-2 sm:px-4 py-3 w-[25%] sm:w-[30%]">{t('dashboard.dates')}</th>
                            <th scope="col" className="px-2 sm:px-4 py-3 w-[15%]">{t('dashboard.type')}</th>
                            <th scope="col" className="px-2 sm:px-4 py-3 text-right w-[15%]">{t('dashboard.size')}</th>
                            <th scope="col" className="px-2 sm:px-4 py-3 text-right w-[20%] sm:w-[15%]">{t('dashboard.result')}</th>
                        </tr>
                    </thead>
                    <tbody>
